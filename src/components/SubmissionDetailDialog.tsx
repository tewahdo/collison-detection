        ...
        <div className="space-y-4 py-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-muted/50 rounded-lg p-3">
              ...
              <span className="capitalize font-semibold text-sm text-foreground">
                {t(`sector.${submission.sectorType}`)}
              </span>
            </div>
            <div className="bg-muted/50 rounded-lg p-3">
              <span className="text-xs text-muted-foreground block mb-0.5">
          ...
          {submission.hasCollision && (
            <div className="rounded-lg bg-destructive/5 border border-destructive/10 p-3 text-sm text-muted-foreground flex items-start gap-2">
              <Info className="h-4 w-4 text-collision shrink-0 mt-0.5" />
              <span>{t("detail.collision.note")}</span>
            </div>
          )}

          {/* NO approve/reject buttons — sector users can only VIEW */}
        </div>
      </DialogContent>
    </Dialog>
  );
