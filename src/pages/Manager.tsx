...
//               {t("manager.tab.pending")}
//             </TabsTrigger>
//             <TabsTrigger value="collisions">
//               {t("manager.tab.collisions")}
//             </TabsTrigger>
//             <TabsTrigger value="approved">
//               {t("manager.tab.approved")}
//             </TabsTrigger>
//             <TabsTrigger value="rejected">
//               {t("manager.tab.rejected")}
//             </TabsTrigger>
//             <TabsTrigger value="all">{t("manager.tab.all")}</TabsTrigger>
//           </TabsList>
